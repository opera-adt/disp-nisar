...
from disp_nisar.browse_image import DEFAULT_CMAP
from disp_nisar.product_info import DISPLACEMENT_PRODUCTS
...
def make_browse(out_fname, in_fname, dataset_name, max_img_dim, cmap, vmin, vmax):
    ...
    import disp_nisar.browse_image

    if out_fname is None:
        out_fname = in_fname.replace(".nc", f".{dataset_name}.png")

    disp_nisar.browse_image.make_browse_image_from_nc(
